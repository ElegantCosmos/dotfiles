...
\includegraphics[width=\linewidth]{cernroot_plots/histogram2D_plot.pdf}% Here is how to import EPS art
\caption{\label{fig:epsart} A figure caption. The figure captions are
automatically numbered. Linewidth \the\linewidth. Textwidth \the\textwidth.}
\end{figure}

\begin{figure}[b]
%\includegraphics{fig_1}% Here is how to import EPS art
\includegraphics[width=\linewidth]{cernroot_plots/histogram_plot.pdf}% Here is how to import EPS art
\caption{\label{fig:epsart} A figure caption. The figure captions are
automatically numbered. Linewidth \the\linewidth. Textwidth \the\textwidth.}
\end{figure}
