...
\includegraphics[width=\linewidth]{matplotlib_plots/test.pdf}% Here is how to import EPS art
...
\begin{figure}[b]
%\includegraphics{fig_1}% Here is how to import EPS art
\includegraphics[width=\linewidth]{matplotlib_plots/test2.pdf}% Here is how to import EPS art
\caption{\label{fig:epsart} A figure caption. The figure captions are
automatically numbered. Linewidth \the\linewidth. Textwidth \the\textwidth.}
\end{figure}
